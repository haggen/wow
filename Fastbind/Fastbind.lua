...
function Fastbind_SetHook(name)
    ...
    if (frame and not frame.hookedForFastbind) then
        ...
        frame:HookScript("OnClick", function(frame)
            if Fastbind.isActive then
...
function FastbindMinimapButton_OnEnter(self)
    ...
    GameTooltip:AddLine("Click to activate.", nil, nil, nil, 1)
    GameTooltip:Show()
end

function FastbindMinimapButton_OnLeave(self)
    GameTooltip:Hide()
end

function FastbindMinimapButton_OnMouseDown(self)
...
function FastbindMinimapButton_OnMouseUp(self)
...
function FastbindMinimapButton_OnClick(self)
    Fastbind_Activate()
end

function FastbindMinimapButton_OnUpdate(self)
...
function FastbindMinimapButton_OnDragStart(self)
    GameTooltip:Hide()
...
function FastbindMinimapButton_OnDragStop(self)
...
function FastbindMinimapButton_OnLoad(self)
